...
class SearchAction extends Action{
	...
	public function result(){
		...
		$user_part_sql_head = "select id user_id, name user_name, aim content, 0 event_id, 0 event_name, work_field field, 0 res_tags, create_time";
		...
		$event_part_sql_head = "select users.id user_id, users.name user_name, description content, events.id event_id, events.name event_name, item_field field, res_tags, events.create_time create_time ";
		if(count($keys) >= 2){	//需要计算搜索分数
